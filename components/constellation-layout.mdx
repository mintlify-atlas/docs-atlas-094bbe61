...
description: "Renders portfolio projects as an interactive star map. Nodes are placed by x/y coordinates, sized by magnitude, and linked by animated SVG dashed lines."
---
